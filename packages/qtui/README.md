...
本地 `qtoc:build` 只产出当前平台版本。详见 `packages/qtui/docs/ops/qtoc-build.md` 3.1 节。
...
完整索引与阅读路径见 `packages/qtui/docs/README.md`：

- 阅读引导：`packages/qtui/docs/README.md`
- 接口参考（188 端点 + SSE 事件）：`packages/qtui/docs/api/qtoc-http-api.md`
- Qt 壳开发指南：`packages/qtui/docs/guide/qt-shell-guide.md`
- 客户端工程导读：`packages/qtui/docs/guide/client-tour.md`
- 集成方法与决策：`packages/qtui/docs/integration/methodology.md`
- 实施步骤：`packages/qtui/docs/integration/implementation.md`
- Headless 发行与验证：`packages/qtui/docs/ops/qt-headless.md`
- 构建与上游同步：`packages/qtui/docs/ops/qtoc-build.md`
- Bun 安装（Windows/Linux）：`packages/qtui/docs/ops/bun-install.md`
